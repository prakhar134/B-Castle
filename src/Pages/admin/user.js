                ...
                <table>
                    ...
                    {user && user.trades && user.trades.reverse()?.map(trade => (
                        <tr>
                            ...
                            <td style={{minWidth: '100px'}}><span style={trade.type === 'buy' ? {padding: '5px 20px', borderRadius: '15px', backgroundColor: 'rgba(0, 250, 50, 0.2)', color: 'green'} : {padding: '1px 20px', borderRadius: '15px', backgroundColor: 'rgba(250, 50, 0, 0.2)', color: 'red'}}>{trade.type}</span></td>
                        </tr>
                    ))}
                </table>
                {
